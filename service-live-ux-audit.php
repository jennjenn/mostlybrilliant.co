...
<div id="service-detail-page" class="container live-ux-audit">
    <div class="row">
	   <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <h2 class="bigoletext text-center service-optimize">Good design sells.</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <h1>Join a live UX Audit. Free.</h1>
    ...
    <div class="row">
        <div id="sign-up-preview" class="col-xs-12 col-sm-6 col-sm-offset-3">
