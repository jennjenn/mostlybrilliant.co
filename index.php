...
<div class="container">
  ...
  <div class="row">
    <div class="col-xs-12">
		<p>Welcome to Mostly Brilliant, an independent Product and UX consultancy focused on helping your small business unlock its potential through design, process, and product improvements. I specialize in helping you translate your big vision into a customer-focused, executable plan that optimizes for maximum impact.</p>
    ...
    <p>A glowing review from Kate Kendall of <a href="http://cloudpeeps.com">CloudPeeps</a>:</p>
    ...
    <input type="hidden" name="product-id" value="audit" />
      <script
        ...
        data-key="pk_live_BAkno0Yvw1qLJhEbJyBhLjT2"
        data-amount="100000"
        ...
        data-label="Book your Audit now"
        data-bitcoin="true">
      </script>
    </form>
...
<div class="service-section">
    ...
    <p>Mostly Brilliant is a proudly independent consultancy. That means it's just me on the other side of this keyboard making all the magic happen. I've built a reputation for being able to do the work of many, do it efficiently, and do it well.</p>
    ...
    <div id="mc_embed_signup">
      <form action="//mostlybrilliant.us13.list-manage.com/subscribe/post?u=4cca0202faa1d268df2007d72&amp;id=92eb669271&SOURCE=site-lead" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
  ...
  <h2>Bonus!</h2>
      <p>Every month I do a (free!) live stream where I audit 3-5 sites in real time and answer your questions. <a href="/live-design-audit">You can find out more about that here.</a></p>
    </div>
  </div>
</div>
