 	...
 	<div id="service-detail-page">
    	...
    	<div class="row">
    		<div class="col-xs-12 col-sm-6 col-sm-offset-3">
                ...
                <p>We do so much patching that sometimes the overall message gets lost. Or worse: the user gets lost. The information architecture we spent so much time defining in the very beginning has come to resemble an M.C. Escher work rather than a user-friendly, optimized experience that ushers our users from the very start to their end goal.</p>
