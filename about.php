 	...
 	<div id="about" class="container">
    	<div class="row">
    		<div class="col-xs-12 col-sm-2 col-sm-offset-1">
    			<img id="photo-jenn" src="img/photo-jenn.jpg" alt="Jenn Vargas" />
    		</div>
    		<div class="col-xs-12 col-sm-8">
                ...
                <ul>
                    <li><a href="http://gigmasters.com" target="_blank">GigMasters (part of XO Group)</a></li>
                    <li><a href="http://brooklynbridge.vc" target="_blank">Brooklyn Bridge Ventures</a></li>
                    <li><a href="http://zaapt.com" target="_blank">Zaapt</a></li>
                    <li><a href="http://gun.io" target="_blank">Gun.io</a></li>
                    <li><a href="http://madewithover.com/" target="_blank">Over</a></li>
                    <li><a href="http://www.katapultstudio.com/" target="_blank">Kandu (now Katapult)</a></li>
				...
				<p><a href="http://linkedin.com/in/jennifervargas">Here's my LinkedIn</a> if you'd like the nitty-gritty.</p>	
    		</div>
    	</div>
    </div>
